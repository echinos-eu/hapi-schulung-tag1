...
- erstellen Sie einen https://simplifier.net/guide/isik-basis-v4/ImplementationGuide-markdown-Datenobjekte-Datenobjekte_Patient?version=current kompatiblen Patienten
- Fügen Sie dem Patienten eine Diagnose hinzu
- Fügen Sie Patient und Diagnose einem Fall hinzu
...
- löschen Sie ihre Diagnosenressource, lesen Sie die Ressource nach dem Löschen mittels der Ressourcen.id