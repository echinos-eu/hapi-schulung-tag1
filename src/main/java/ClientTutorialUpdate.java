...
public class ClientTutorialUpdate {
  ...
  public static void main(String[] args) {
    ...
    Bundle bundle = client.search().byUrl("Patient?birthdate=1982-04-03&_total=accurate")
        .returnBundle(Bundle.class).execute();
    System.out.println(iParser.encodeResourceToString(bundle));
    System.out.println(bundle.getTotal());

    //Suche incl. Encounter & Conditions:
    Bundle bundleRevInclude = client.search()
        .byUrl("Patient?birthdate=1982-04-03&_total=accurate&_revinclude=Encounter:subject&_revinclude=Condition:subject")
        .returnBundle(Bundle.class).execute();
    System.out.println(iParser.encodeResourceToString(bundleRevInclude));
    System.out.println(bundleRevInclude.getTotal());
//    Patient isikPatient = getIsikPatient();
//    isikPatient.setId("examplePatrick");
//    isikPatient.getNameFirstRep().addGiven(UUID.randomUUID().toString());
...
//    System.out.println("PatientenId: " + patientId);
